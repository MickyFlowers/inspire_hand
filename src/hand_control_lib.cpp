...
namespace inspire_hand
{
    ...
    hand_serial::hand_serial(ros::NodeHandle *nh, std::string node_name) : act_position_(-1),
                                                                           hand_state_(0xff)
    {
        // Read launch file params

        // nh->getParam(node_name + "/hand_id", hand_id_);
        nh->getParam(node_name + "/portname", port_name_);
        nh->getParam(node_name + "/baudrate", baudrate_);
        nh->getParam(node_name + "/test_flags", test_flags);
    ...
    int
    hand_serial::start(serial::Serial *port, int id)
    {
    ...
    bool
    hand_serial::setID(serial::Serial *port, int id, int set_id)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setREDU_RATIO(serial::Serial *port, int id, int redu_ratio)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    bool
    hand_serial::setCLEAR_ERROR(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setSAVE_FLASH(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setRESET_PARA(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setFORCE_CLB(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setGESTURE_NO(serial::Serial *port, int id, int gesture_no)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    bool
    hand_serial::setCURRENT_LIMIT(serial::Serial *port, int id, int current0, int current1, int current2, int current3, int current4, int current5)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    bool
    hand_serial::setDEFAULT_SPEED(serial::Serial *port, int id, int speed0, int speed1, int speed2, int speed3, int speed4, int speed5)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setDEFAULT_FORCE(serial::Serial *port, int id, int force0, int force1, int force2, int force3, int force4, int force5)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    bool
    hand_serial::setUSER_DEF_ANGLE(serial::Serial *port, int id, int angle0, int angle1, int angle2, int angle3, int angle4, int angle5, int k)
    ...
    bool
    hand_serial::setPOS(serial::Serial *port, int id, int pos0, int pos1, int pos2, int pos3, int pos4, int pos5)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    bool
    hand_serial::setANGLE(serial::Serial *port, int id, int angle0, int angle1, int angle2, int angle3, int angle4, int angle5)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    bool
    hand_serial::setFORCE(serial::Serial *port, int id, int force0, int force1, int force2, int force3, int force4, int force5)
    {
        std::vector<uint8_t> output;
    ...
    bool
    hand_serial::setSPEED(serial::Serial *port, int id, int speed0, int speed1, int speed2, int speed3, int speed4, int speed5)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getPOS_ACT(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getANGLE_ACT(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getFORCE_ACT(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getCURRENT(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    uint8_t
    hand_serial::getERROR(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getSTATUS(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getTEMP(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getPOS_SET(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getANGLE_SET(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
    ...
    void
    hand_serial::getFORCE_SET(serial::Serial *port, int id)
    {
        std::vector<uint8_t> output;
        // message from master to module
        output.push_back(0xEB);
                               ...
                               inspire_hand::set_id::Response &res)
    {
        ...
        {
            res.idgrab = setID(com_port_, req.id, req.set_id);
            return true;
        }
        else
        {
                                       ...
                                       inspire_hand::set_redu_ratio::Response &res)
    {
        ...
        {
            res.redu_ratiograb = setREDU_RATIO(com_port_, req.id, req.redu_ratio);
            return true;
        }
        else
        {
                                        ...
                                        inspire_hand::set_clear_error::Response &res)
    {
        ...
        res.setclear_error_accepted = setCLEAR_ERROR(com_port_, req.id);
        return true;
    }
                                       ...
                                       inspire_hand::set_save_flash::Response &res)
    {
        ...
        res.setsave_flash_accepted = setSAVE_FLASH(com_port_, req.id);
        return true;
    }
                                       ...
                                       inspire_hand::set_reset_para::Response &res)
    {
        ...
        res.setreset_para_accepted = setRESET_PARA(com_port_, req.id);
        return true;
    }
                                      ...
                                      inspire_hand::set_force_clb::Response &res)
    {
        ...
        res.setforce_clb_accepted = setFORCE_CLB(com_port_, req.id);
        return true;
    }
                                       ...
                                       inspire_hand::set_gesture_no::Response &res)
    {
        ...
        {
            res.gesture_nograb = setGESTURE_NO(com_port_, req.id, req.gesture_no);
            return true;
        }
        else
        {
                                          ...
                                          inspire_hand::set_current_limit::Response &res)
    {
        ...
        if (req.current0 >= 0 && req.current1 >= 0 && req.current2 >= 0 && req.current3 >= 0 && req.current4 >= 0 && req.current5 >= 0)
        {
            ...
            {
                res.current_limit_accepted = setCURRENT_LIMIT(com_port_, req.id, req.current0, req.current1, req.current2, req.current3, req.current4, req.current5);
                return true;
            }
            else
            {
                                          ...
                                          inspire_hand::set_default_speed::Response &res)
    {
        ...
        if (req.speed0 >= 0 && req.speed1 >= 0 && req.speed2 >= 0 && req.speed3 >= 0 && req.speed4 >= 0 && req.speed5 >= 0)
        {
            ...
            {
                res.default_speed_accepted = setDEFAULT_SPEED(com_port_, req.id, req.speed0, req.speed1, req.speed2, req.speed3, req.speed4, req.speed5);
                return true;
            }
            else
            {
                                          ...
                                          inspire_hand::set_default_force::Response &res)
    {
        ...
        if (req.force0 >= 0 && req.force1 >= 0 && req.force2 >= 0 && req.force3 >= 0 && req.force4 >= 0 && req.force5 >= 0)
        {
            ...
            {
                res.default_force_accepted = setDEFAULT_FORCE(com_port_, req.id, req.force0, req.force1, req.force2, req.force3, req.force4, req.force5);
                return true;
            }
            else
            {
                                           ...
                                           inspire_hand::set_user_def_angle::Response &res)
    {
        ...
        if (req.angle0 >= 0 && req.angle1 >= 0 && req.angle2 >= 0 && req.angle3 >= 0 && req.angle4 >= 0 && req.angle5 >= 0)
        {
            ...
            {
                res.angle_accepted = setANGLE(com_port_, req.id, req.angle0, req.angle1, req.angle2, req.angle3, req.angle4, req.angle5);
                return true;
            }
                                ...
                                inspire_hand::set_pos::Response &res)
    {
        ...
        if (req.pos0 >= 0 && req.pos1 >= 0 && req.pos2 >= 0 && req.pos3 >= 0 && req.pos4 >= 0 && req.pos5 >= 0)
        {
            ...
            {
                res.pos_accepted = setPOS(com_port_, req.id, req.pos0, req.pos1, req.pos2, req.pos3, req.pos4, req.pos5);
                return true;
            }
            else
            {
                                  ...
                                  inspire_hand::set_force::Response &res)
    {
        ...
        if (req.force0 >= 0 && req.force1 >= 0 && req.force2 >= 0 && req.force3 >= 0 && req.force4 >= 0 && req.force5 >= 0)
        {
            if (req.force0 <= 1000 && req.force1 <= 1000 && req.force2 <= 1000 && req.force3 <= 1000 && req.force4 <= 1000 && req.force5 <= 1000)
            {
                res.force_accepted = setFORCE(com_port_, req.id, req.force0, req.force1, req.force2, req.force3, req.force4, req.force5);
                return true;
            }
            else
            {
                                  ...
                                  inspire_hand::set_speed::Response &res)
    {
        ...
        if (req.speed0 >= 0 && req.speed1 >= 0 && req.speed2 >= 0 && req.speed3 >= 0 && req.speed4 >= 0 && req.speed5 >= 0)
        {
            if (req.speed0 <= 1000 && req.speed1 <= 1000 && req.speed2 <= 1000 && req.speed3 <= 1000 && req.speed4 <= 1000 && req.speed5 <= 1000)
            {
                res.speed_accepted = setSPEED(com_port_, req.id, req.speed0, req.speed1, req.speed2, req.speed3, req.speed4, req.speed5);
                return true;
            }
